// src/components/UnlockClient.tsx
'use client'
...
function UnlockCore({ initialNext }: Props) {
  ...
  // 如果你仍想从 URL 重新读取，也可以使用：
  // const params = useSearchParams()
  // const next = params.get('next') || initialNext
...
/**
 * 最顶层用 Suspense 包裹 UnlockCore，确保 useSearchParams 等异步 hook 被正确处理【citeturn0search6】
 */
